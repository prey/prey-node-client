...
- 1.3.7-rc [\#80](https://github.com/prey/prey-node-client/pull/80) ([lemavri](https://github.com/lemavri))
...
- Add users to group with gpasswd instead of adduser [\#50](https://github.com/prey/prey-node-client/pull/50) ([mickael9](https://github.com/mickael9))
...
- Add a Gitter chat badge to README.md [\#46](https://github.com/prey/prey-node-client/pull/46) ([gitter-badger](https://github.com/gitter-badger))
...
- Add repl completer [\#23](https://github.com/prey/prey-node-client/pull/23) ([josher19](https://github.com/josher19))

- WIP - Building Tests [\#19](https://github.com/prey/prey-node-client/pull/19) ([hermanjunge](https://github.com/hermanjunge))

- Fixed Mac get\_access\_points\_list. [\#1](https://github.com/prey/prey-node-client/pull/1) ([dtorres](https://github.com/dtorres))
