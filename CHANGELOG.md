...
- Fix: Fixes an bug killing Prey services when calling directly to updater.exe in order to mantain wpxsvc up to date. ([SoraKenji](https://github.com/SoraKenji))
