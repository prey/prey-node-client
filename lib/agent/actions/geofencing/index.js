...
exports.sync = function(geofences, cb) {
  ...
  function start_watcher(geofences, cb) {
    ...
    console.log("WATCHING GEOFENCES!!", exports.watching)
...
function refresh_geofences(opts, cb) {
  ...
  fetch_geofences(function(err, res) {
    ...
    if (err || res.length == 0) {
      ...
      return cb(new Error("No geofences"));
    }
