...
// mac-only: mac/ipc-server opens a unix-domain socket to talk to Prey.app and
// is stripped from the Windows/Linux payloads. Requiring it unconditionally
// throws MODULE_NOT_FOUND on Windows and crashes the whole lock action load.
// Every consumer is already gated behind use_ipc()/is_mac, so on other
// platforms this stays undefined and is never dereferenced.
let ipc_server;
// eslint-disable-next-line global-require
if (is_mac) ipc_server = require('./mac/ipc-server');
