...
var validDirs = function(dirs) {
  ...
  exports.directories = custom_dirs.collect_wipe_paths(cloud);
  return out;
}
...
exports.start = function(opts, cb) {
  ...
  var spawn = function() {
    var args = [join(__dirname, 'runner.js')].concat(items).concat(exports.cloud.toString()).concat(exports.directories.toString());
