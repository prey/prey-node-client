...
exports.start = function(opts, cb) {
  ...
  var spawn = function() {
    ...
    system.spawn_as_admin_user(exports.node_bin, args, function(err, child) {
      ...
      if (typeof child == 'function') {  // only for windows
        ...
        wipe.fetch_dirs(items, exports.directories, exports.cloud, ['-token', token], (err, dirs_to_wipe) => {
          var opts = {
            dirs:   dirs_to_wipe,
            token:  token,
  ...
  emitter = new Emitter;
  cb(null, emitter);
  fs.existsSync(exports.node_bin) ? spawn() : finished(new Error('Node binary not present'));
