...
exports.perform = function(command) {
  ...
  if (method) {
    ...
    if (command.command != 'start'){
      ...
      verify_if_no_exist_id(type,id,command.target,command.options,function (err,no_exist) {
        if (no_exist) {
...
var verify_if_no_exist_id = function(type, id, name,opts, cb) {
