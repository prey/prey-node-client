...
var verify_if_exist_id = function(type, id, name,opts, cb) {
  console.log("verify_if_exist_id")
  console.log("verify_if_exist_id")
  console.log("verify_if_exist_id")
  console.log("verify_if_exist_id")
  console.log("verify_if_exist_id")
  //storage2.do('query', {type: 'commands',column : "id", id: id, data: id }, function (err,rows) {
    storage2.do('find', {type: 'commands',column:  "id", id: id, data: {command: type, target: name, options: opts }}, function (err,rows) {
    
    console.log("params22222")
    console.log("params22222")
    console.log("params22222")
    console.log(rows)
    console.log("params22222")
...
var watch_stopped = function() {
  ...
  hooks.on('action', function(event, id) {
    console.log("pasa por hooks on watch stopped")
    console.log("pasa por hooks on watch stopped")
    console.log("pasa por hooks on watch stopped")
    console.log("pasa por hooks on watch stopped")
    console.log("pasa por hooks on watch stopped")
