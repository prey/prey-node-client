...
exports.notify_action = (
  ...
  if (out) {
    ...
    else if (action === 'factoryreset') { toSend.body.reason = { status_code: out.data, status_msg: out.message }; } else if (action === 'fullwipe') { toSend.body.reason = { status_code: out.data, status_msg: out.message }; }
  }
  if (err) {
