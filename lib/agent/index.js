...
const run = () => {
  ...
  runVerificationPreyConfiguration(() => {
    console.log('pablito clavo un clavito 1');
    // updater.check_for_update((err) => {
    console.log('pablito clavo un clavito 2');
    restore((msg) => {
      console.log('pablito clavo un clavito 3');
      if (typeof msg === 'string') logger.info(msg);
      console.log('pablito clavo un clavito 4');
      // eslint-disable-next-line consistent-return
      saveDataDbPreyConfRestart('0', () => {
        console.log('pablito clavo un clavito 5');
        return boot();
        console.log('pablito clavo un clavito 6');
