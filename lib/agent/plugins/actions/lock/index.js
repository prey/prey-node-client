...
var Lock = function(options){
	...
	this.password = options.password || options.unlock_pass || 'e75f0173be748b6f68b3feb61255693c'; // "preyrocks", by default
	if (this.password.length !== 32) this.password = this.digest_password(this.password);
