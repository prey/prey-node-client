...
exports.post_location = function(data, cb) {
  ...
  request.post('/devices/' + keys.get().device + '/location.json', data, { json: true }, function(err, resp) {
    if (err) return cb(err);
...
exports.post_sso_status = function(data, cb) {
  ...
  request.post('/devices/client_configuration', data, { json: true }, function(err, resp) {
    if (err) return cb(err);
