var needle = require('needle'),
    ...
    os_name = common.system.os_name,
    os_release = common.system.os_release;

// Capitalize OS name
os_name = os_name[0].toUpperCase() + os_name.slice(1);

var defaults = {
  client        : needle,
  protocol      : 'https',
  host          : 'solid.preyproject.com',
  user_agent    : 'Prey/' + version + ' (Node '+ process.version + ' ' + os_name + ' ' + os_release + ')',
