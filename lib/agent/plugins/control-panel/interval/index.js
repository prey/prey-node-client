...
function load_hooks() {
	// hooks are unnecessary right now, since request keeps happening even while disconnected
	// TODO @lemavri implement hooks on connect/disconnect to start/stop requests to api
  loaded = true;
}
