...
var load_config_request = function(cb) {
...
exports.load = function(cb) {
  var common      = this,
      config_file = require('getset').load({ path: join(common.system.paths.config, 'prey.conf'), type: 'file' });

  if (!config_file.get('control-panel.device_key'))
    return load_config_request(cb);
