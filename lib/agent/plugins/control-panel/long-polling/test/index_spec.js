...
// Update config object to reflect local server settings
Object.keys(prey_cfg).forEach(function(k) {
  common.config._values['control-panel'][k] = prey_cfg[k];
});
...
var spy = sinon.spy(getter, 'commands'),
