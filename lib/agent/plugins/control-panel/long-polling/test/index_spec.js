...
describe('long-polling', function() {
  ...
  before(function() {
    ...
    storage_exist_stub = sinon.stub(device_keys, 'exist').callsFake((coso, cb) => {
      return cb(null);
    });

    storage_store_stub = sinon.stub(device_keys, 'store').callsFake((coso1, coso2, cb) => {
      return cb(null);
    });

    storage_update_stub = sinon.stub(device_keys, 'update').callsFake((coso1, coso2, coso3, cb) => {
      return cb(null);
    });
