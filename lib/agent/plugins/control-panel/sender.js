...
exports.notify_action = function(status, id, name, opts, err, out) {
  ...
  if (err && (name == 'fullwipe' || name == 'fullwipewindows')) body = { command : body.command, target :opts.target , status : 'stopped', reason : { status_code :  (err.code)?err.code : 1 , status_msg : err.message } };
