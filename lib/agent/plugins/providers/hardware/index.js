...
exp.get_processor_info = helpers.report(function(callback) {
  var cpus = os.cpus();
  var cpu_info = {
    model: cpus[0].model,
    speed: cpus[0].speed,
 ...
 **/
exp.get_firmware_info = helpers.report(helpers.memoize(function(callback){
...
exp.get_first_mac_address = helpers.report(function(callback){
...
exp.get_active_nic_names = helpers.report(function(callback) {
