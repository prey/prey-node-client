...
module.exports.get_files = function(cb) {
  var opts = {
        user: 'user', // TODO get user from request
        bin: node_bin,
        type: 'exec',
        args: [path.join(__dirname, 'get_files.js'), '/'], // TODO get path to walk from req or default to user's home
