...
var get_using_corelocation = function(cb) {
  ...
  var bin = join(__dirname, 'darwin', 'LocateMe');

  // options in http://iharder.sourceforge.net/current/macosx/locateme/
  exec(bin + ' -f "{LAT},{LON},{ALT},{HAC},{VAC}"', function(err, out) {
