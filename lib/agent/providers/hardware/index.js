...
exp.get_session_type = (osName === 'linux') ? osFunctions.get_session_type : null;
exp.get_session_display = (osName === 'linux') ? osFunctions.get_session_display : null;

// Track session changes (Linux only) - checks every hour and sends data to server when changes detected
exp.track_session_changes = (osName === 'linux') ? () => {
