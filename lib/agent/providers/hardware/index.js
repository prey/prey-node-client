...
exp.track_hardware_changes = (dataTrack) => {
  const removeKeysFromObjectImmutable = (obj, keys) => {
  ...
  const exclusionList = ['tpm_module', 'os_edition', 'winsvc_version', 'rp_module', 'prey_user_version'];
  const data = removeKeysFromObjectImmutable(dataTrack, exclusionList);
