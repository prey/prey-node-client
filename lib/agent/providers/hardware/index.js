...
exp.get_processor_info  = (osName == 'mac') ? os_functions.get_processor_info : exp.get_processor_info;///////////////
exp.get_prey_user_version = (osName == 'mac') ?  os_functions.get_prey_user_version : null;
