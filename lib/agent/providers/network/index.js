...
if (osName == 'mac' && common.osRelease >= "10.15")
  exp.get_active_network_interface = os_functions.get_active_interface;
else
...
exp.get_active_access_point = function(callback) {
  os_functions.get_active_access_point(function(err, stdout) {
    if (err) {
