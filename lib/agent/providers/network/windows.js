...
const os = require('os');
const { networkInterfaceDefault } = require('../../utils/utilinformation');
const common = require('../../common');
const permissionsWindows = require('../../permissions/windows');
...
exports.get_wireless_interfaces_list = (callback) => {
  networkInterfaceDefault((defaultNetwork) => {
...
exports.isWifiPermissionActive = (callback) => {
  permissionsWindows.getLocationPermission(callback);
};
