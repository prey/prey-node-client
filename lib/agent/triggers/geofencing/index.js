...
var location;
var last_location = {lat: 0, lng: 0, accuracy: 0, method: null};
  ...
  this.start = function(callback) {
    function get_location() {
      geo.get_location(function(err, coords) {
        if (err) {
          logger.debug('There was a problem verifying location');
          return callback();
        }
    ...
    get_location();
    this.loop = setInterval(get_location, this.interval);
