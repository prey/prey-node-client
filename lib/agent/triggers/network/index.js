...
// var check_mac_address_changed = function(data) {
//   device_keys.get_stored('mac', function(err, stored_mac) {
//     if (!stored_mac) {
//       device_keys.store('mac', data);
//       return;
//     }
//     if (stored_mac && data != stored_mac) {
//       emitter.emit('mac_address_changed');
//       device_keys.update('mac', stored_mac, data);
//     }
//     // device_keys.update('mac', data);
//   })
// }
