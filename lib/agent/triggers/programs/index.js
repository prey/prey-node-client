...
var ProgramsTrigger = function(options){

	var self = this;
	this.interval = options.interval || 3000; // every three seconds
	...
	this.watch = function(){
		...
		this.loop = setInterval(function(){
			processes.get_process_list(getter_callback);
		}, this.interval);
...
util.inherits(ProgramsTrigger, Emitter);

exports.events = ['program_opened', 'program_closed'];

exports.start = function(options, callback){
	var watcher = this.watcher = new ProgramsTrigger(options || {});
	this.watcher.watch();
	process.nextTick(function(){
		callback && callback(null, watcher);
	})
}
