...
var types = {
  ...
  responses: {
    ...
    values: (data) => { return `'${data.id}', '${data.action_id}', '${data.opts}', '${data.out}', '${data.error}', '${data.status}', '${data.action}' , '${data.time}', 0` }
  },
  geofences: {
