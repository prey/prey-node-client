  ...
  exec(exports.existsNewPath, { timeout: 5000 }, (_error, stdout) => {
    if (stdout && stdout.trim() !== '') {
      ...
      exec(`launchctl unload ${pathLaunchDaemon}${newWatcherKey}`, { timeout: 15000 }, (errorUnload) => {
        ...
        waitForProcessToStop('prey-user', 5000, (waitErr) => {
          ...
          system.get_os_version((err, osVersion) => {
            ...
            if (greaterOrEqual('13.0.0', osVersion)) {
              return exec(exports.deleteInstallPreyUserPath, { timeout: 10000 }, () => {
                exec(exports.copyCurrentToInstallVersionPath, { timeout: 10000 }, (error) => {
