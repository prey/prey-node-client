...
var config_path   = system.paths.config,
    install_path  = system.paths.install,
...
var releases_url = 'http://localhost:8888/';
...
//        versions.set_current(version || 'this', cb);
  ...
  cli.command('verify', 'Verifies API/Device keys. If none are passed, the ones in config file are used.', function(cmd){
