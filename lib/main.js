...
var Main = {
	...
	initialize: function(callback){
		...
		logger.write("\n  PREY " + common.version + " spreads its wings!", 'purple');
		...
		if(this.config.device_key == ""){
			...
			logger.warn("No device key found.")
			...
			if(this.config.api_key == ""){
				...
				var attach_device = require('./register').new_device,

				attach_device(function(device_key){
