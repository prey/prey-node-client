...
*/
	...
	setup_driver: function(driver){
		...
		// driver.on('done', function(){ self.unload_driver(driver.name); })
	...
	load_transport: function(context, endpoint_options){
		...
		for(endpoint_name in endpoint_options){
			...
			plugins.load_transport(endpoint_name, options, null, function(loaded_transport){
