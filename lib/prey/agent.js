...
var common     = _ns('common'),
    ...
    self,
    random_between = common.helpers.random_between;
...
var Agent  = self = {  
  ...
  run: function(){
    ...
    var start_wait_time = (!common.terminal || common.terminal === 'dumb') ? random_between(1, 59) : 0;
  ...
  load_driver: function(driver_name, driver_options){
    ...
    if (self.drivers[driver_name])
      return self.log_error(driver_name + " driver already loaded");

    _tr("loading driver :"+driver_name);
