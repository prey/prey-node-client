...
exports.modules_url = exports.control_panel_url + '/modules';
exports.profile_url = 'https://control.preyproject.com/profile' + request_format;
exports.signup_url = 'https://control.preyproject.com/register' + request_format;
...
exports.device = function(device_key){
	...
	return {
		...
		data_url: url + '/data' + request_format,
