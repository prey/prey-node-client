...
var modules_url = common.constants.modules_url;
var modules_path = common.modules_path;
...
function ModuleUpdater(module_name){
	...
	this.get = function(remote_package, module_path){
		...
		var dw = new Download(remote_package, common.helpers.tempfile_path("prey-module-" + tempfile));
