...
var exec = require('child_process').exec,
		...
		randomBetween = require('./../../helpers').randomBetween,
...
exports.set_new_delay = function(new_delay, callback){
	...
	var delay_string = new_delay == 60 ? randomBetween(1, 59) : "*/" + new_delay;

	var cmd = 'crontab -l | grep -v "' + script_path + '"; \
	echo "' + delay_string + " * * * * " + script_path + ' > /var/log/prey.log 2>&1" | crontab -'
