...
var ControlPanelDriver = function(options){
	...
	this.set_urls = function(){
		...
		this.endpoints = {
			device: {
				url: 'http://' + this.config.host + '/devices/' + this.config.device_key + '.xml',
				method: 'put'
			},
			events: {
				url: 'http://' + this.config.host + '/devices/' + this.config.device_key + '/events.xml',
				method: 'put'
			},
			location: {
				url: 'http://' + this.config.host + '/devices/' + this.config.device_key + '/reports.xml',
				method: 'post'
			}
		}

		this.endpoints.hardware = this.endpoints.device;
