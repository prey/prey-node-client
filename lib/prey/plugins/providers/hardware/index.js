...
var Hardware = function() {
   ...
   **/
  this.get_firmware_info = helpers.memoize(function(callback){
  ...
  this.get_broadcast_address = helpers.memoize(function(nic_name, callback) {
   ...
   * optional hasher function.
   **/
  this.get_network_interfaces_list = helpers.memoize(function(callback) {
   ...
   * 
   **/
  this.get_mac_address = helpers.memoize(function(nic_name, callback) {
