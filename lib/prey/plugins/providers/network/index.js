...
var Network = function(){
   ...
   **/
  this.get_public_ip = async.memoize(function(callback){
  ...
  this.get_public_ip.report = "Public IP";
  
  /**
   * Callsback an internal IP address.
   **/
  this.get_private_ip = async.memoize(function(callback){
  ...
  this.get_private_ip.report = "Private IP";
   ...
   * @param {String} platform specific name, e.g. eth0, Local Area Connection
   **/
  this.get_nic_by_name = async.memoize(function(name, callback) {
    hardware.get_network_interfaces_list(function(err, list){
   ...
   **/
  this.get_active_network_interface = async.memoize(function(callback){
  ...
  this.get_active_network_interface.report = "Active Network Interface";
  ...
  this.get_active_access_point.report = "Active Access Point";
  ...
  this.get_access_points_list.report = "Access Points";
