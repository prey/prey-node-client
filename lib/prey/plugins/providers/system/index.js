...
var System = function(){
   ...
   **/
  this.get_logged_user = helpers.report(function(callback){
   ...
   **/
  this.get_uptime = helpers.report(function(callback){
   ...
   **/
  this.get_remaining_battery = helpers.report(function(callback){
  ...
  this.get_battery_info = function(callback) {
    os_functions.get_battery_info(callback);
  };
  
  /**
   * Callsback object with last_min, last_five and last_fifteen fields of load
   **/  
  this.get_cpu_load = helpers.report(function(callback){
    var data = os.loadavg();
    var info = { last_min: data[0], last_five: data[1], last_fifteen: data[2] };
    callback(null, info);
  });

  this.get_memory_usage = helpers.report(function(callback) {
   ...
   **/
  this.get_remaining_storage = helpers.report(function(callback){
