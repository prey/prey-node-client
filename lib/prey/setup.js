...
var messages = {
	copying_config: "Generating new config file...",
	...
	setup_success: "Prey has been setup successfully!",
...
var run = exports.run = function(){
	...
	if (config.persisted()){
		...
		console.log(messages.copying_config);
		...
		config.sync(common.default_config_file, function(err){
			...
			// fs.chmod(common.default_config_file, '640');
			...
			keys.generate(key_paths, function(err){
