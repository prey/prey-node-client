var fs         = require('fs'),
    ...
    remember   = require('./../utils/remember'),
...
system.get_logged_user = function(cb){

  var in_cache = remember('logged_user');
  if (in_cache)
    return cb(null, in_cache);
  ...
  system.find_logged_user(function(err, user){
    ...
    remember('logged_user', logged_user);
  })
