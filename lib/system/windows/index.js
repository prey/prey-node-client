...
exports.reconnect = function(cb) {
  var cmd_path = bin_path('autowc.exe');
...
exports.check_service = function(cb) {
  if (monitoring_service_go) return cb(null);

  needle.post(LOCALHOST_ACTION, {}, { json : true }, function(err, resp, body) {
    if (err) return cb(err);
    monitoring_service_go = true;
    return cb(null);
  });
}
