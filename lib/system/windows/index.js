...
exports.find_logged_user = (callback) => {
  ...
  try {
    exec('powershell -Command "(Get-WmiObject -Class win32_computersystem).UserName"', { timeout: 10000, cwd: __dirname }, (err, psout) => {
      ...
      try {
        exec(
          ...
          (errPower, sidout) => {
            ...
            try {
              exec('powershell -Command "(Get-Process -Name LogonUI -ErrorAction SilentlyContinue).SessionId"', { timeout: 10000, cwd: __dirname }, (errPowerGet, lockedSid) => {
