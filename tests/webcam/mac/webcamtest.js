...
const macWebcam = require('../../../lib/agent/providers/webcam/mac/index.js');
...
describe('done', () => {
  ...
  it('should execute the callback function with error if err is truthy', () => {
    ...
    // Call the function
    macWebcam.done(err, '/path/to/file', cb);
  ...
  it('should execute the callback function with filePath and mimeType if err is falsy', () => {
    ...
    // Call the function
    macWebcam.done(null, '/path/to/file', cb);
  ...
  it('should set running to false', () => {
    // Call the function
    macWebcam.done(null, '/path/to/file', sinon.spy());

    // Assertion
    macWebcam.running.should.be.false; // Remove this line if you don't want to use Chai
  });

  it('should clear the timer if it exists', () => {
    // Test setup
    macWebcam.timer = setTimeout(() => {}, 1000);

    // Call the function
    macWebcam.done(null, '/path/to/file', sinon.spy());

    // Assertion
    macWebcam.timer.should.be.null; // Remove this line if you don't want to use Chai
  });
});
